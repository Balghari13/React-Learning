  ...
  return (
    <header className="flex justify-between px-4 py-4 shadow-md md:px-8">
      ...
      <ul className="flex gap-4 align-middle">
        <li>
          <NavLink to="/" className={({isActive})=>isActive ? "text-blue-700 underline" : ''} >Home</NavLink>
        </li>
        <li>
          <NavLink to="/about" className={({isActive})=>isActive ? "text-blue-700 underline" :''}>About</NavLink>
        </li>
        <li>
          <NavLink to="/contact" className={({isActive})=>isActive ?"text-blue-700 underline":''}>Contact</NavLink>
        </li>
        <li>
          <button onClick={()=>{
            setIsOpen(true)
          }}>Sign In</button>
          <Model isOpen={isOpen} setIsOpen={setIsOpen} header={<div className="text-xl font-bold">Sign In</div>}
